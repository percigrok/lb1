...
word2 = secret_message[1][9:13]  # 10-13 буквы
word3 = secret_message[2][5:15:2]  # 6-15 буквы через одну
word4 = secret_message[3][7:13][::-1]  # 8-13 буквы в обратном порядке
word5 = secret_message[4][16:21][::-1]  # 17-21 буквы в обратном порядке
